...
def obtain_retrain_autodeeplab_args():
    ...
    parser.add_argument('--dataset', type=str, default='sealer', help='pascal, cityscapes or sealer')
    ...
    parser.add_argument('--max_iteration', default=1000000, type=bool)
    parser.add_argument('--net_arch', default=None, type=str, help='network_path.npy')
    parser.add_argument('--cell_arch', default=None, type=str, help='genotype.npy')
    ...
    parser.add_argument('--num_layers', type=int, default=12, help='architecture number of layers')
